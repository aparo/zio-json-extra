...
object ErrorCode {
  ...
  val EarlyHints =
    103 // "Early Hints", "The server is likely to send a final response with the header fields included in the response." // RFC 8297

  val OK      = 200 // "OK", "OK"
  val Created = 201 // "Created", "The request has been fulfilled and resulted in a new resource being created."
  val Accepted =
    202 // "Accepted", "The request has been accepted for processing, but the processing has not been completed."
  val NonAuthoritativeInformation =
    203 // "Non-Authoritative Information", "The server successfully processed the request, but is returning information that may be from another source."
  val NoContent =
    204 // "No Content", "The server successfully processed the request and is not returning any content.", allowsEntity = false
  val ResetContent =
  ...
  val MultipleChoices =
    300 // "Multiple Choices", "There are multiple options for the resource that the client may follow.", "There are multiple options for the resource that the client may follow. The preferred one is <a href=\"%s\">this URI</a>."
  val MovedPermanently =
    301 // "Moved Permanently", "This and all future requests should be directed to the given URI.", "This and all future requests should be directed to <a href=\"%s\">this URI</a>."
  val Found =
    302 // "Found", "The resource was found, but at a different URI.", "The requested resource temporarily resides under <a href=\"%s\">this URI</a>."
  val SeeOther =
    303 // "See Other", "The response to the request can be found under another URI using a GET method.", "The response to the request can be found under <a href=\"%s\">this URI</a> using a GET method."
  val NotModified =
    304 // "Not Modified", "The resource has not been modified since last requested.", "", allowsEntity = false
  val UseProxy =
    305 // "Use Proxy", "This single request is to be repeated via the proxy given by the Location field.", "This single request is to be repeated via the proxy under <a href=\"%s\">this URI</a>."
  val TemporaryRedirect =
    307 // "Temporary Redirect", "The request should be repeated with another URI, but future requests can still use the original URI.", "The request should be repeated with <a href=\"%s\">this URI</a>, but future requests can still use the original URI."
  val PermanentRedirect =
    308 // "Permanent Redirect", "The request, and all future requests should be repeated using another URI.", "The request, and all future requests should be repeated using <a href=\"%s\">this URI</a>."
  ...
  val MisdirectedRequest =
    421 // "Misdirected Request", "The request was directed at a server that is not able to produce a response." // HTTP/2 only. https://tools.ietf.org/html/rfc7540#section-9.1.2
  ...
  val HTTPVersionNotSupported =
    505 // "HTTP Version Not Supported", "The server does not support the HTTP protocol version used in the request."
  val VariantAlsoNegotiates =
